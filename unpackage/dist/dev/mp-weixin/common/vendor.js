...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"平城热线","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 10:
/*!*********************************!*\
  !*** E:/h5-12345/until/auth.js ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function wxAuthorize() {
  ...
  if (params.code) {
    ...
    var authURL = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".concat(appid, "&redirect_uri=").concat(uri, "&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect");
    window.location.href = authURL;
  }
}var _default =
{ wxAuthorize: wxAuthorize };exports.default = _default;
...
MinRequest = /*#__PURE__*/function () {function MinRequest() {_classCallCheck(this, MinRequest);_defineProperty(this,
    ...
    url, data) {var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      ...
      options.method = 'PUT';
      return this.request(options);
    } }, { key: "postAuthorization", value: function postAuthorization(
    url, data) {var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      options.url = url;
      options.data = data;
      options.method = 'POST';
      options.header = _objectSpread({
        // ...options,
        'Authorization': 'WT-APP-TOKEN',
        'token': 'WT-APP-TOKEN',
        'WT-APP-TOKEN': uni.getStorageSync('WT-APP-TOKEN') },
      options);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _MinRequest = _interopRequireDefault(__webpack_require__(/*! ./MinRequest */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var project_name = '/hotline-data-exchange-open-platform-web';
var wechat_name = '/seats.easy8in.top';var _default =
{
  apis: {
    /* S 授权 */
    authorization: function authorization(data) {
      return minRequest.post("".concat(project_name, "/openApi/app/authorization"), _objectSpread({}, data));


    },
    /* E 授权 */
    /* S  查询码*/
    searchByCode: function searchByCode(data) {
      return minRequest.get("".concat(project_name, "/wechat/appeal/searchByCode"), _objectSpread({}, data));


    },
    /* E 查询码 */
    /* S  短信验证码*/
    verificationCode: function verificationCode(data) {
      return minRequest.post("".concat(project_name, "/openApi/send/verificationCode"), _objectSpread({}, data));


    },
    /* E  短信验证码*/
    /* S 图形验证码 */
    wechat_matchPic: function wechat_matchPic(data) {
      return minRequest.get("".concat(project_name, "/wechat/matchPic"), _objectSpread({}, data));


    },
    /* E  图形验证码*/
    /* S 微页面提交诉求 */
    saveOpenApiAppeal: function saveOpenApiAppeal(data) {
      return minRequest.postAuthorization("".concat(project_name, "/openApi/appeal/save"), _objectSpread({}, data));


    },
    /* E  微页面提交诉求*/
    /*  S  诉求类型  */
    getAppealCategory: function getAppealCategory(data) {
      return minRequest.get("".concat(project_name, "/openApi/hotlineAppealCategory/list"), _objectSpread({}, data));
    ...
    /* S 诉求类别 */
    getAppealType: function getAppealType(data) {
      return minRequest.get("".concat(project_name, "/openApi/hotLineAppealType/list"), _objectSpread({}, data));


    },
    /* E 诉求类别 */
    /* S 事件辖区  */
    getAppealJurisdiction: function getAppealJurisdiction(data) {
      return minRequest.get("".concat(project_name, "/openApi/hotLineAppealJurisdiction/list"), _objectSpread({}, data));


    },
    /* E 事件辖区  */
    /* S 微提交 - 我的工单 */
    addHotlineToWechat: function addHotlineToWechat(data) {
      return minRequest.postAuthorization("".concat(project_name, "/wechat/addHotlineToWechat"), _objectSpread({}, data));


    },
    /* E  微提交 - 我的工单*/
    /* S 热点动态 */
    articlelist: function articlelist(data) {
      return minRequest.postAuthorization("".concat(project_name, "/openApi/article/list"), _objectSpread({}, data));


    },
    articleinfo: function articleinfo(data) {
      return minRequest.get("".concat(project_name, "/openApi/article/info"), _objectSpread({}, data));


    },
    /* E 热点动态 */
    /* S 微信授权 */
    wanteng_wechat: function wanteng_wechat(data) {
      return minRequest.get("".concat(wechat_name, "/login/test"), _objectSpread({}, data));


    },
    wanteng_userinfo: function wanteng_userinfo(data) {
      return minRequest.get("".concat(wechat_name, "/user"), _objectSpread({}, data));


    },
    /* E 微信授权 */
    /* S 个人信息-添加 */
    addWechatUser: function addWechatUser(data) {
      return minRequest.post("".concat(project_name, "/wechat/addWechatUser"), _objectSpread({}, data));


    },
    /* E 个人信息 添加*/
    /* S 个人信息-修改 */
    updateWechatUser: function updateWechatUser(data) {
      return minRequest.post("".concat(project_name, "/wechat/updateWechatUser"), _objectSpread({}, data));


    },
    /* E 个人信息 修改*/
    /* S 个人信息获取 */
    infouser: function infouser(data) {
      return minRequest.get("".concat(project_name, "/wechat/info/user"), _objectSpread({}, data));


    },
    /* E  个人信息获取 */
    /* S 我的工单 */
    hotlinePage: function hotlinePage(data) {
      return minRequest.post("".concat(project_name, "/wechat/hotlinePage"), _objectSpread({}, data));


    },
    /* E  我的工单*/
    /* S 我的工单详情 */
    myOrderInfo: function myOrderInfo(data) {
      return minRequest.get("".concat(project_name, "/wechat/hotline/info"), _objectSpread({}, data));


    },
    /* E  我的工单详情 */
    /* S  我的收藏*/
    articlePage: function articlePage(data) {
      return minRequest.post("".concat(project_name, "/wechat/articlePage"), _objectSpread({}, data));
    ...
    addArticle: function addArticle(data) {
      return minRequest.post("".concat(project_name, "/wechat/addArticle"), _objectSpread({}, data));


    },
    /* E 收藏 */
    /* S  取消收藏*/
    cancelArticle: function cancelArticle(data) {
      return minRequest.put("".concat(project_name, "/wechat/cancelArticle"), _objectSpread({}, data));


    }
    /* E 取消收藏 */ } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  {
    value: 7,
    label: '举报' }] };exports.default = _default;

/***/ }),

/***/ 164:
/*!*************************************************!*\
  !*** E:/h5-12345/components/uni-icons/icons.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var goodsList = [{
  ...
  sales: 61,
  name: "大同市卫生学校",
  text: " 大同市卫生学校始建于1972年，2009年由大同市第一、二卫生学校合并重组为大同市卫生学校，是一所国办全日" },
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  imgPath: '/',
  validateCodePath: '/hotline-data-exchange-open-platform-web/captchaJpg' };exports.default = _default;
